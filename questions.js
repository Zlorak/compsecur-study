...
const QUESTIONS = [
  ...
  // ----- Cryptography, set 2 (Domain 1) -----
  { cat: "Cryptography", q: "Which cipher encrypts data one bit or byte at a time?", o: ["Stream cipher", "Block cipher", "Hash function", "Digital signature"], a: 0, e: "Stream ciphers (RC4, ChaCha20) encrypt continuously; block ciphers like AES work on fixed-size blocks." },
  { cat: "Cryptography", q: "Which AES mode provides built-in authentication (integrity) of the ciphertext?", o: ["GCM", "ECB", "CBC", "CTR"], a: 0, e: "Galois/Counter Mode is authenticated encryption (confidentiality + integrity). ECB is insecure; CBC/CTR need a separate MAC." },
  { cat: "Cryptography", q: "Why is post-quantum cryptography being developed?", o: ["Quantum computers could break RSA/ECC", "Symmetric keys are too long", "Hashing is reversible", "TLS is deprecated"], a: 0, e: "A large quantum computer could break RSA/ECC via Shor's algorithm, so quantum-resistant algorithms are being standardized." },
  { cat: "Cryptography", q: "All else equal, a longer encryption key generally provides:", o: ["Greater resistance to brute force", "Faster encryption", "Smaller ciphertext", "Reversible hashing"], a: 0, e: "More key bits means an exponentially larger keyspace, raising brute-force cost (with a small performance trade-off)." },
  { cat: "Cryptography", q: "Making code or data hard to understand without truly encrypting it is:", o: ["Obfuscation", "Hashing", "Tokenization", "Key stretching"], a: 0, e: "Obfuscation hides meaning/intent but is not real encryption; it raises effort, not guaranteed secrecy." },
  { cat: "Cryptography", q: "A hash collision is when:", o: ["Two inputs share the same hash", "A key is reused twice", "A certificate expires", "Salt is omitted"], a: 0, e: "Collisions (two inputs, one digest) undermine integrity; the birthday attack finds them faster than brute force. MD5/SHA-1 are weak." },
  { cat: "Cryptography", q: "A blockchain provides integrity primarily through:", o: ["A chained, tamper-evident ledger", "Symmetric encryption of each block", "Centralized access control", "Password hashing"], a: 0, e: "Each block stores the previous block's hash, so altering one block breaks the chain — a distributed, tamper-evident ledger." },

  // ----- PKI & Certificates, set 2 (Domain 1) -----
  { cat: "PKI & Certificates", q: "Which certificate file format is Base64 ASCII text, common on web servers?", o: ["PEM", "DER", "PFX", "P12"], a: 0, e: "PEM is Base64/ASCII (.pem/.crt). DER is binary; PFX/P12 (PKCS#12) bundle the cert plus private key, usually password-protected." },
  { cat: "PKI & Certificates", q: "A digital certificate binds a public key to:", o: ["A verified identity", "A private key it contains", "A password hash", "An IP address only"], a: 0, e: "An X.509 certificate binds a public key to a CA-verified identity (subject). The private key is never stored inside the certificate." },

  // ----- Social Engineering (Domain 2) -----
  { cat: "Social Engineering", q: "An attacker invents a believable scenario (e.g., posing as IT) to extract info. This is:", o: ["Pretexting", "Tailgating", "Shoulder surfing", "Dumpster diving"], a: 0, e: "Pretexting uses a fabricated story/persona to build trust and elicit information or access." },
  { cat: "Social Engineering", q: "Searching an organization's trash for sensitive documents is:", o: ["Dumpster diving", "Pretexting", "Vishing", "Pharming"], a: 0, e: "Dumpster diving recovers discarded sensitive data. Counter it with shredding and secure disposal." },
  { cat: "Social Engineering", q: "Watching someone enter a PIN over their shoulder is:", o: ["Shoulder surfing", "Tailgating", "Eliciting information", "Prepending"], a: 0, e: "Shoulder surfing observes screens/keypads directly. Privacy screens and awareness reduce it." },
  { cat: "Social Engineering", q: "Calling the help desk while pretending to be an executive to reset a password is:", o: ["Impersonation", "Watering hole", "Typosquatting", "Logic bomb"], a: 0, e: "Impersonation assumes another's identity to gain trust/access. Strong help-desk identity verification defends against it." },
  { cat: "Social Engineering", q: "Spreading deliberately false information to manipulate opinion is:", o: ["Disinformation", "Misconfiguration", "Pivoting", "Sideloading"], a: 0, e: "Disinformation is intentionally false (vs misinformation = unintentional). Influence campaigns weaponize it at scale." },
  { cat: "Social Engineering", q: "Silently redirecting users to a fake site by poisoning DNS, with no click needed, is:", o: ["Pharming", "Phishing", "Vishing", "Smishing"], a: 0, e: "Pharming poisons DNS or the hosts file to redirect users; phishing instead relies on luring a click." },
  { cat: "Social Engineering", q: "A fake email copying a trusted brand's logo and domain to steal credentials is:", o: ["Brand impersonation", "Watering hole", "Race condition", "War driving"], a: 0, e: "Brand impersonation mimics a known brand's look/domain to lend phishing false legitimacy." },

  // ----- Malware, set 2 (Domain 2) -----
  { cat: "Malware", q: "Malware that records every keystroke to capture passwords is a:", o: ["Keylogger", "Worm", "Rootkit", "Bot"], a: 0, e: "Keyloggers capture typed input (credentials, messages); they can be software or hardware." },
  { cat: "Malware", q: "Software that secretly gathers a user's activity and data is:", o: ["Spyware", "Ransomware", "A worm", "A logic bomb"], a: 0, e: "Spyware covertly monitors and exfiltrates user behavior/data; adware is a related nuisance form." },
  { cat: "Malware", q: "A network of compromised hosts remotely controlled by an attacker is a:", o: ["Botnet", "Honeynet", "Subnet", "VLAN"], a: 0, e: "Bots in a botnet take orders from a command-and-control (C2) server, often for DDoS or spam." },
  { cat: "Malware", q: "Malware that runs in memory via legitimate tools (e.g., PowerShell) and leaves few files is:", o: ["Fileless malware", "A boot-sector virus", "Adware", "A macro virus"], a: 0, e: "Fileless malware lives in memory and abuses built-in tools (living off the land), evading file-based AV." },
  { cat: "Malware", q: "Hijacking a victim's CPU/GPU to secretly mine cryptocurrency is:", o: ["Cryptojacking", "Ransomware", "Phishing", "Tailgating"], a: 0, e: "Cryptojacking steals compute to mine coins; signs include high CPU usage and sluggish performance." },
  { cat: "Malware", q: "Malware giving an attacker full covert remote control of a host is a:", o: ["Remote-access Trojan", "Rootkit", "Keylogger", "Bloatware"], a: 0, e: "A RAT provides hidden remote control/backdoor access, often delivered inside a trojan." },

  // ----- Application & network attacks, set 2 (Domain 2) -----
  { cat: "Application Attacks", q: "Input that makes a web app run OS shell commands on the server is:", o: ["Command injection", "Cross-site scripting", "Clickjacking", "Smurfing"], a: 0, e: "Command injection passes attacker input to a system shell. Avoid shelling out; validate and escape input." },
  { cat: "Application Attacks", q: "Manipulating directory queries by injecting filter characters is:", o: ["LDAP injection", "SQL injection", "CSRF", "Replay"], a: 0, e: "LDAP injection abuses unsanitized input in directory queries; like SQLi, fix with input validation/escaping." },
  { cat: "Threats & Attacks", q: "Systematically trying every possible password combination is a:", o: ["Brute-force attack", "Phishing attack", "Replay attack", "Downgrade attack"], a: 0, e: "Brute force tries all combinations; lockouts, MFA, and key stretching make it impractical." },
  { cat: "Threats & Attacks", q: "Trying words from a precompiled wordlist against an account is a:", o: ["Dictionary attack", "Birthday attack", "Smurf attack", "Evil twin"], a: 0, e: "Dictionary attacks use likely passwords/words. Salting and strong, unique passwords reduce success." },
  { cat: "Threats & Attacks", q: "Which attack uses probability math to find hash collisions faster?", o: ["Birthday attack", "Brute-force attack", "Replay attack", "Pharming"], a: 0, e: "The birthday attack leverages the birthday paradox to find collisions with far fewer attempts than brute force." },
  { cat: "Threats & Attacks", q: "Sending small spoofed requests to servers that fire large replies at a victim is a:", o: ["Reflection/amplification DDoS", "Replay attack", "Watering hole", "Privilege escalation"], a: 0, e: "Amplification (DNS/NTP/memcached) reflects large responses toward a spoofed victim IP, multiplying traffic." },
  { cat: "Threats & Attacks", q: "Breaking out of a guest VM to reach the hypervisor or host is:", o: ["VM escape", "VLAN hopping", "Pivoting", "Sideloading"], a: 0, e: "VM escape exploits hypervisor flaws to reach the host or other VMs. Patch hypervisors and isolate workloads." },

  // ----- Vulnerabilities & indicators (Domain 2) -----
  { cat: "Vulnerability Management", q: "Software that no longer receives vendor security patches is:", o: ["End-of-life / legacy", "Zero-day", "A false positive", "A baseline"], a: 0, e: "EOL/legacy systems get no patches, so risk grows; isolate, replace, or wrap with compensating controls." },
  { cat: "Vulnerability Management", q: "Leaving default credentials or unnecessary open services on a device is a:", o: ["Misconfiguration", "Zero-day", "Logic bomb", "Race condition"], a: 0, e: "Misconfigurations (defaults, open ports, weak settings) are a top vulnerability; hardening baselines fix them." },
  { cat: "Vulnerability Management", q: "Removing a phone's built-in restrictions to install unapproved apps is:", o: ["Jailbreaking / rooting", "Sideloading", "Tokenizing", "Sandboxing"], a: 0, e: "Jailbreaking/rooting strips OS restrictions, weakening security; sideloading installs apps from outside official stores." },
  { cat: "Security Operations", q: "A user logs in from two distant countries minutes apart. This indicator is:", o: ["Impossible travel", "A false positive", "A legal hold", "A baseline"], a: 0, e: "Impossible/risky travel flags logins too far apart in time and space to be one person — likely stolen credentials." },

  // ----- Secure architecture, set 2 (Domain 3) -----
  { cat: "Architecture & Cloud", q: "Which IPsec mode encrypts the entire original packet, used in site-to-site VPNs?", o: ["Tunnel mode", "Transport mode", "Aggressive mode", "Promiscuous mode"], a: 0, e: "Tunnel mode encrypts the whole packet and adds a new header (gateway-to-gateway). Transport mode protects only the payload." },
  { cat: "Architecture & Cloud", q: "Which IPsec protocol provides encryption (confidentiality), not just integrity?", o: ["ESP", "AH", "GRE", "PPTP"], a: 0, e: "Encapsulating Security Payload encrypts and authenticates; Authentication Header gives integrity/authentication but no encryption." },
  { cat: "Architecture & Cloud", q: "Running event-driven code without managing servers, scaling on demand, is:", o: ["Serverless computing", "Bare-metal hosting", "A jump server", "A honeypot"], a: 0, e: "Serverless/Function-as-a-Service runs code on demand; the provider handles servers and scaling. You still secure code and configs." },
  { cat: "Architecture & Cloud", q: "Separating the network control plane from the data plane for central programmability is:", o: ["Software-defined networking", "Network address translation", "Spanning tree", "Link aggregation"], a: 0, e: "SDN centralizes control logic so the network is programmable via controllers and APIs." },
  { cat: "Network Security", q: "Applying granular per-workload security policies inside a data center is:", o: ["Microsegmentation", "Subnetting", "NAT", "Port mirroring"], a: 0, e: "Microsegmentation isolates individual workloads to limit lateral movement — a Zero Trust practice." },
  { cat: "Network Security", q: "Which technology routes WAN traffic across multiple links by policy?", o: ["SD-WAN", "VLAN", "RAID", "DLP"], a: 0, e: "Software-defined WAN steers traffic across MPLS/broadband/LTE by policy; SASE adds security to it." },
  { cat: "Network Security", q: "Managing devices over a separate dedicated channel isolated from production is:", o: ["Out-of-band management", "In-band management", "Port forwarding", "Split tunneling"], a: 0, e: "Out-of-band management uses a separate path (console/management network), surviving production outages and reducing exposure." },
  { cat: "Network Security", q: "Which email mechanism lets a domain publish which servers may send its mail?", o: ["SPF", "DKIM", "DMARC", "S/MIME"], a: 0, e: "SPF lists authorized sending IPs; DKIM signs messages; DMARC combines them with a policy and reporting." },
  { cat: "Data Protection", q: "Encrypting only specific sensitive columns (e.g., SSNs) in a database is:", o: ["Field-level encryption", "Full-disk encryption", "Transport encryption", "Steganography"], a: 0, e: "Field/record-level encryption protects specific data elements; FDE protects the whole disk at rest." },
  { cat: "Resilience & Recovery", q: "Grouping servers so another instantly takes over if one fails provides:", o: ["High availability", "Data masking", "Tokenization", "Federation"], a: 0, e: "Clustering/high availability provides automatic failover and redundancy to minimize downtime." },

  // ----- Security operations, set 2 (Domain 4) -----
  { cat: "Physical Security", q: "Which reliably destroys data on an SSD, where degaussing does NOT work?", o: ["Crypto-erase", "Degaussing", "Defragmentation", "A quick format"], a: 0, e: "SSDs aren't magnetic, so degaussing fails. Use crypto-erase (destroy the key) or physically shred the drive." },
  { cat: "Security Operations", q: "Blocking connections to known-malicious domains at resolution time is:", o: ["DNS filtering", "NAT", "Port mirroring", "Tokenization"], a: 0, e: "DNS filtering/sinkholing stops connections to malicious or disallowed domains before they resolve." },
  { cat: "Security Operations", q: "Which appliance enforces acceptable use and blocks malicious sites for outbound web traffic?", o: ["Secure web gateway", "Load balancer", "TPM", "RAID controller"], a: 0, e: "A secure web gateway / web filter inspects and controls outbound web access (URL filtering, malware scanning)." },
  { cat: "Security Operations", q: "Detecting threats by baselining normal user activity and flagging anomalies is:", o: ["User behavior analytics", "Port scanning", "Tokenization", "Patch management"], a: 0, e: "UEBA learns normal behavior and alerts on deviations (impossible travel, odd hours) — strong against insider/compromised accounts." },
  { cat: "Security Operations", q: "After an incident, determining the underlying cause to prevent recurrence is:", o: ["Root cause analysis", "Chain of custody", "Threat hunting", "A tabletop exercise"], a: 0, e: "Root cause analysis (part of lessons learned) finds the true origin so the same incident doesn't repeat." },
  { cat: "Security Operations", q: "Which data source records full network traffic for deep forensic analysis?", o: ["Packet capture", "DHCP lease file", "CRL", "Risk register"], a: 0, e: "Packet captures (Wireshark/tcpdump) record actual traffic for protocol/forensic analysis; NetFlow gives only metadata." },

  // ----- IAM, set 2 (Domain 4) -----
  { cat: "IAM", q: "Which token-based framework is commonly used for API authorization and mobile apps?", o: ["OAuth 2.0", "SAML", "RADIUS", "Kerberos"], a: 0, e: "OAuth 2.0 handles delegated authorization (often with OIDC for authentication); SAML is XML-based, common for enterprise web SSO." },
  { cat: "IAM", q: "A hardware security key using FIDO2 enables which login approach?", o: ["Passwordless authentication", "Shared-account login", "Plaintext passwords", "Single-factor only"], a: 0, e: "FIDO2/WebAuthn keys enable phishing-resistant passwordless or strong second-factor authentication." },
  { cat: "IAM", q: "Which tool best helps users keep unique, complex passwords for every site?", o: ["A password manager", "A desktop spreadsheet", "Reusing one strong password", "Disabling lockouts"], a: 0, e: "Password managers generate and store unique strong credentials in an encrypted vault, fighting password reuse." },
  { cat: "IAM", q: "Granting elevated rights only for a short, approved window is:", o: ["Just-in-time access", "Standing admin access", "Implicit allow", "Shared root login"], a: 0, e: "Just-in-time access provisions privileges temporarily and revokes them automatically, shrinking the attack window." },
  { cat: "IAM", q: "Verifying that a person really is who they claim before issuing credentials is:", o: ["Identity proofing", "Federation", "Accounting", "Tokenization"], a: 0, e: "Identity proofing validates a claimed identity (documents, knowledge, biometrics) during enrollment." },

  // ----- Program management, set 2 (Domain 5) -----
  { cat: "Risk & Governance", q: "A risk assessment that runs automatically and ongoing, not on a fixed schedule, is:", o: ["Continuous", "Ad hoc", "One-time", "Annual"], a: 0, e: "Continuous assessment monitors risk in near real time; ad hoc is as-needed; recurring is on a set cadence." },
  { cat: "Governance & Third-Party", q: "Under GDPR, a person requesting deletion of their personal data exercises the:", o: ["Right to be forgotten", "Right to escalate privileges", "Right of audit", "Right of way"], a: 0, e: "The right to erasure lets data subjects request deletion of their personal data, subject to legal exceptions." },
  { cat: "Governance & Third-Party", q: "A likely consequence of failing a regulatory compliance requirement is:", o: ["Fines and sanctions", "Faster hardware", "Lower latency", "More disk space"], a: 0, e: "Non-compliance can bring fines, sanctions, reputational damage, contract loss, or losing a license." },
  { cat: "Governance & Third-Party", q: "Under GDPR, the role responsible for overseeing data protection compliance is the:", o: ["Data Protection Officer", "Data custodian", "Network admin", "Help-desk lead"], a: 0, e: "The DPO advises on and monitors GDPR compliance and is a contact point for regulators and data subjects." },
  { cat: "Governance & Third-Party", q: "The document defining scope, limits, and authorization for a penetration test is the:", o: ["Rules of engagement", "Risk register", "CRL", "Baseline"], a: 0, e: "Rules of engagement (with written authorization) define scope, timing, methods, and boundaries so testing stays legal and safe." },
  { cat: "Governance & Third-Party", q: "A contract clause letting a customer assess a vendor's security controls is a:", o: ["Right-to-audit clause", "Non-compete clause", "Force majeure clause", "Indemnity waiver"], a: 0, e: "Right-to-audit clauses let the customer verify a vendor's controls via audits or questionnaires during the relationship." },
  { cat: "Governance & Third-Party", q: "An agreement forming a partnership between two firms and defining responsibilities is a:", o: ["BPA", "NDA", "SLA", "RTO"], a: 0, e: "A Business Partners Agreement (BPA) sets the terms, roles, and profit/responsibility split between partner organizations." },
  { cat: "Governance & Third-Party", q: "A policy defining how employees may use company systems and the internet is the:", o: ["Acceptable Use Policy", "Incident response plan", "Disaster recovery plan", "Business impact analysis"], a: 0, e: "The Acceptable Use Policy (AUP) sets rules for acceptable use of organizational resources; users typically sign it." },
];
